...
% Set hyperref options before loading (to avoid option clash)
\PassOptionsToPackage{unicode=true,pdfusetitle}{hyperref}
% Load hyperref last (except for some specific packages)
\usepackage{hyperref}
...
\newtcbtheorem[auto counter, number within=section]{lemmabox}{Lemma}{
  colback=gray!5!white,
  colframe=black!60,
  coltitle=black,
  fonttitle=\bfseries,
